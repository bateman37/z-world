...
| [DEC-0020](DEC-0020_mutable-environment-and-agriculture.md) | `approved` | Entorno mutable y agricultura (`WEB-002` S10): capas de cobertura/vía/barrera sobre la geometría de fondo ya generada, perímetro derivado por unión-búsqueda (nunca un booleano guardado), agricultura y entorno mutable en el mismo motor de trabajos/planificador que S4-S9 (ningún motor paralelo), geometría de parcela libre con aptitud causal, progreso parcial persistente ante interrupción, reloj determinista de crecimiento sin atajos, siembra derivada de la semilla realmente disponible, fórmula de rendimiento causal provisional, y límites honestos frente a S11. |
| [DEC-0021](DEC-0021_final-integration-closure.md) | `approved` | Cierre final de integración (`WEB-002` S11): protocolo Worker V3 en canales estructural/tick con resincronización explícita, persistencia idempotente por `attemptId` y congelación real por conflicto de revisión, registro operativo persistente y reconstruible, selección universal del Canvas con ficha contextual única, herramientas gráficas de dibujo como flujo primario, reasignación/ritmo de trabajos y visibilidad de recursos reservados, recorrido cruzado completo de barrera/perímetro, harness de rendimiento documentado, y límites honestos/deuda explícita posterior. |
