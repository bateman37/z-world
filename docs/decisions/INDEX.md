...
| [DEC-0008](DEC-0008_character-catalog-and-resolution-engine-domain.md) | `approved` | Cerrar el catálogo de nueve características/34 habilidades y crear el dominio del motor de resolución en `90-architecture`. |
