...
[ARC-006](../90-architecture/ARC-006_action-and-event-resolution-model.md#33-posibilidad-requisitos-y-acciones-básicas-sin-tirada)).
...
[ARC-006](../90-architecture/ARC-006_action-and-event-resolution-model.md#32-características-habilidades-y-medias),
...
2. **Natación.** Desenvolverse en el agua: cruzar ríos, canales, embalses,
   ...
   automáticas ([ARC-006](../90-architecture/ARC-006_action-and-event-resolution-model.md#33-posibilidad-requisitos-y-acciones-básicas-sin-tirada));
...
5. **Advertir.** Habilidad clave del motor: prestar atención, detectar que
   ...
   definir; ver
   [ARC-007](../90-architecture/ARC-007_teamwork-orders-modes-and-conditions.md#33-modos-de-ejecución-significado-corregido)).
...
30. **Liderazgo.** Dirigir, coordinar, organizar grupos, tomar
    ...
    [ARC-007](../90-architecture/ARC-007_teamwork-orders-modes-and-conditions.md#31-trabajo-en-equipo-con-un-líder)).
