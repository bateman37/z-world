...
### 3.1 Relación con las capas de aprovechamiento de un edificio

Las cinco capas de aprovechamiento de un edificio (contenido suelto,
mobiliario y equipamiento, instalaciones desmontables, acabados
recuperables y estructura) son canónicas de
[SET-007 §3.1](SET-007_building-exploitation-reuse-and-demolition.md#31-cinco-capas-de-aprovechamiento);
este documento no las redefine. Este documento se concentra en lo que
ocurre **dentro** de las capas 1 a 3 (contenido suelto, mobiliario y
equipamiento, instalaciones): cómo un objeto completo, una vez recuperado o
localizado, se modela y en qué familias logísticas abstractas puede
transformarse. La estructura de un edificio (capa 5) y su desmantelamiento
o demolición pertenecen íntegramente al sistema de edificios de
[SET-007](SET-007_building-exploitation-reuse-and-demolition.md) y
mantienen reglas propias, fuera de este alcance.
...
- El desmontaje que transforma un objeto completo en estas familias vive en
  [SET-009](SET-009_disassembly-and-world-transformation.md).
- Las cinco capas de aprovechamiento de un edificio, sus tres vidas y la
  diferencia entre desmontaje selectivo y demolición a nivel estructural
  son canónicas de
  [SET-007](SET-007_building-exploitation-reuse-and-demolition.md); este
  documento solo desarrolla el modelo de objeto y las familias logísticas
  que resultan de las capas 1 a 3 de esa clasificación.
