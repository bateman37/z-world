...
[SET-007](SET-007_object-model-and-logistics-families.md), se reconoce,
...
| Demolición | Consumir la estructura de un edificio para recuperar materiales masivos. | Elimina el uso futuro del edificio; pertenece al sistema de edificios, con reglas propias fuera de este alcance (ver [SET-007 §3.1](SET-007_object-model-and-logistics-families.md#31-capas-de-aprovechamiento-de-un-lugar)). |
...
[ARC-004](../90-architecture/ARC-004_action-and-event-resolution-model.md#34-modelo-b-resolución-porcentual)
(PENDIENTE, ver §5).
...
- El modelo de objeto, sus atributos y las familias logísticas viven en
  [SET-007](SET-007_object-model-and-logistics-families.md); este documento
  no los redefine.
