...
- `90-architecture` (separación entre simulación y presentación; `ARC-006`
  a `ARC-008` son `approved` desde `DESIGN-006` y cierran las fórmulas de
  cooperación, modos y presentación que `UI-006` y `UI-004` consumen sin
  redefinir).
