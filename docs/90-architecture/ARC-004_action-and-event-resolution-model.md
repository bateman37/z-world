...
Este documento y sus capítulos [ARC-005](ARC-005_teamwork-orders-modes-and-conditions.md)
y [ARC-006](ARC-006_outcomes-knowledge-events-and-validation.md) forman el
...
dos modelos de resolución (B y D). ARC-005 cubre cooperación, órdenes,
modos, tiempo, estado, herramientas y entorno. ARC-006 cubre resultados,
...
| Evento | Cambio significativo que puede afectar al mundo, a un trabajo o al conocimiento (ver [ARC-006](ARC-006_outcomes-knowledge-events-and-validation.md#32-eventos-y-consecuencias-sistémicas)). |
...
[ARC-006](ARC-006_outcomes-knowledge-events-and-validation.md#4-preguntas-abiertas)).
...
[ARC-006](ARC-006_outcomes-knowledge-events-and-validation.md#5-ejemplos-no-normativos)).
...
4. Incidencias y eventos con causas y consecuencias pertinentes (ver
   [ARC-006](ARC-006_outcomes-knowledge-events-and-validation.md)).
...
- Consume la taxonomía de trabajo, prioridades y orígenes de trabajo de
  ...
  redefinirla.
- Continúa en
  [ARC-005](ARC-005_teamwork-orders-modes-and-conditions.md) para
  cooperación, órdenes, modos, tiempo, estado, herramientas y entorno.
- Continúa en
  [ARC-006](ARC-006_outcomes-knowledge-events-and-validation.md) para
