...
Continuar [ARC-004](ARC-004_action-and-event-resolution-model.md) con las
...
[SET-007](../40-settlement/SET-007_object-model-and-logistics-families.md#5-herramientas);
...
- Depende del procedimiento común, las capacidades efectivas y los modelos
  B/D de [ARC-004](ARC-004_action-and-event-resolution-model.md).
